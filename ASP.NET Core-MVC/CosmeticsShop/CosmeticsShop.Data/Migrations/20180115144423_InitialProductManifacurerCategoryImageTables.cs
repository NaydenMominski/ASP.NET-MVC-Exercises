...
{
    public partial class InitialProductManifacurerCategoryImageTables : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateModified = table.Column<DateTime>(nullable: false),
                    Description = table.Column<string>(nullable: false),
                    ManifacturerId = table.Column<Guid>(nullable: false),
                    Name = table.Column<string>(maxLength: 50, nullable: false),
                    Price = table.Column<decimal>(maxLength: 2147483647, nullable: false),
                    Published = table.Column<bool>(nullable: false),
                    SpecialPrice = table.Column<decimal>(maxLength: 2147483647, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Products_Manufacturers_ManifacturerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_ManifacturerId",
                table: "Products",
